...
@section('title', 'Newsphere | Baca Berita Terupdate')
...
@section('content')
              ...
              <div
                ...
                <div class="relative z-10 mb-3" style="padding-left: 10px;">
                  ...
                  <div class="flex items-center gap-1 mt-1">
                    <img src="{{ asset('storage/' .$banner->news->author->avatar) }}" alt="{{ $banner->news->author->name }}" class="w-5 h-5 rounded-full object-cover">
        ...
        @foreach ($featureds as $featured)
          <a href="{{ route('news.show', $featured->slug) }}">
            <div
              ...
              <div class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">{{ $featured->newsCategory->title }}</div>
    ...
    <!-- Pilihan Author -->
    <div class="flex flex-col px-14 mt-10 mb-16">
      <div class="flex flex-col md:flex-row justify-between items-center w-full mb-6">
        <div class="font-bold text-2xl text-center md:text-left">
          <p>Pilihan Author</p>
        </div>
